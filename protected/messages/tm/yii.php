...
return array (
  ...
  'CSecurityManager.encryptionKey cannot be empty.' => 'CSecurityManager.encryptionKey boş goýulmayar.',
  'CSecurityManager.validationKey cannot be empty.' => 'CSecurityManager.validationKey boş goýulmayar.',
  ...
  'Unable to resolve the request "{route}".' => '"{route}" işlemi ýerine ýetirilmedi.',
  'Unable to write file "{file}".' => '"{file}" üýtgetmäge rugsat ýok.',
  'Unknown authorization item "{name}".' => '"{name}" bilinmeyen yetkilendirme öğesi.',
  'Unknown type "{type}".' => 'Tanalmaýan görnüş "{type}".',
  'Unrecognized locale "{locale}".' => 'Tanalmalmaýan dil faýly "{locale}".',
  'View file "{file}" does not exist.' => 'Görkeziş faýly "{file}" tapylmady.',
  'Yii application can only be created once.' => 'Yii sistemasy diňe bir gezek döredilip bilinýär.',
  'You are not authorized to perform this action.' => 'Bu işlemi ýerine ýetirmek üçin ýeterli hukugyňyz ýok.',
  'Your request is invalid.' => 'Dogry isleg.',
  'Your request is not valid.' => 'Ýalňyş isleg.',
  ...
  '{attribute} cannot be blank.' => '{attribute} boş goýulmayar.',
