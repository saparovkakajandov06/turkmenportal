...
//                $this->layout='//layouts/login';
	...
	protected function updateMenuItems($model = null)
	{
		...
		switch( $this->action->id)
		{
			case 'restore':
				{
					$this->menu[] = array('label'=>Yii::t('app', '$LNG_BACKUP_VIEW') , 'url'=>Yii::app()->HomeUrl);
				}
			case 'create':
				{
					$this->menu[] = array('label'=>Yii::t('app', '$LNG_BACKUP_LIST') . ' ' . $model->label(2), 'url'=>array('index'));
				}
				break;
			case 'upload':
				{
					$this->menu[] = array('label'=>Yii::t('app', '$LNG_BACKUP_ADD') . ' ' . $model->label(), 'url'=>array('create'));
				}
				break;
			default:
				{
					$this->menu[] = array('label'=>Yii::t('app', '$LNG_BACKUP_ADD') . ' ' . $model->label(), 'url'=>array('create'),'icon'=>"icon-plus icon-white",'type'=>'success');
					$this->menu[] = array('label'=>Yii::t('app', '$LNG_BACKUP_UPLOAD') . ' ' . $model->label(), 'url'=>array('upload'),'icon'=>"icon-upload",);
					$this->menu[] = array('label'=>Yii::t('app', '$LNG_BACKUP_INITIAL_RESTORE') . ' ' . $model->label(), 'url'=>array('restore'),'icon'=>"icon-inbox icon-white",'type'=>'danger');
//					$this->menu[] = array('label'=>Yii::t('app', 'Clean Database') . ' ' . $model->label(), 'url'=>array('clean'));
//					$this->menu[] = array('label'=>Yii::t('app','$LNG_HOME') , 'url'=>Yii::app()->HomeUrl,'icon'=>"icon-home icon-white",'type'=>'warning');
				}
				break;
		}
	}
