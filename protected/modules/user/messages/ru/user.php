...
return array(
	...
	'Please check your email. An instructions was sent to your email address.' => 'На ваш адрес электронной почты было отправлено письмо с инструкциями. (Если не нашли письмо посмотрите на спам папку)',
    ...
    'You have requested the password recovery site {site_name}'=>'Вы подали заявку на изменение пароля от Вашего аккаунта на сайте {site_name}',
    'You have requested the password recovery site {site_name}. To receive a new password, go to {activation_url}.'=>'Вы подали заявку на изменение пароля от Вашего аккаунта на сайте {site_name}. Для того чтобы изменить пароль, перейдите по следующей ссылке {activation_url}',
