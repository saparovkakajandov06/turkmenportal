...
$this->menu=array(
    ...
    array('label'=>UserModule::t('Delete Profile Field'), 'url'=>'#','htmlOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>UserModule::t('Are you sure to delete this item?'))),
