...
//        array_push($rules, array('verifyCode', 'application.extensions.recaptcha.EReCaptchaValidator', 'privateKey' => Yii::app()->params['reCaptcha']['privateKey']));
        array_push($rules, array('verifyCode', 'application.extensions.reCaptcha2.SReCaptchaValidator', 'secret' => Yii::app()->params['reCaptcha']['privateKey'], 'message' => 'The verification code is incorrect.'));
		return $rules;
	}
