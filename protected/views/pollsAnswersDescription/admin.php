...
$this->breadcrumbs = array(
    Yii::t('app', 'Polls Answers Descriptions') => array('index'),
    Yii::t('app', 'Manage'),
);
...
$.fn.yiiGridView.update('polls-answers-description-grid', {
data: $(this).serialize()
});
return false;
});
...
<h1> <?php echo Yii::t('app', 'Manage'); ?> <?php echo Yii::t('app', 'Polls Answers Descriptions'); ?> </h1>
...
'id' => 'polls-answers-description-grid',
