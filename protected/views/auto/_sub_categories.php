...
//                    echo "<li>".CHtml::link($subcatModel->name,Yii::app()->createUrl('//auto/category',array('category_id'=>$subcatModel->id)))."</li>";
//                }
//                echo "</ul>";
//            }
        ?>
...
//            ));
        ...
        <?php if ($this->route != 'auto/category') $this->beginWidget('DNofollowWidget'); ?>
            <?php
                $sub_categories=$modelCategory->children;
                if(isset ($sub_categories) && count($sub_categories)>0){
                    echo "<ul>";
            ...
            ?>
        <?php if ($this->route != 'auto/category') $this->endWidget(); ?>
</div>
