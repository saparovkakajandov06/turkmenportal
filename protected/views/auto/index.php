    ...
    <div class="">
        <div class="level2_cont_inner">
            ...
            <div class="col-sm-9 border-left level2_cont_right">
                ...
                <?php echo CHtml::link(Yii::t('app', "Add"), Yii::app()->createUrl('item/index', array('code' => 'auto', 'category_id' => $modelCategory->id)), array('class' => 'tp-btn pull-right')); ?>
                <?php
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        //                $this->widget('application.widgets.banners.BannersWidget', array(
                        //                    'type' => 'mobile_content_top',
                        //                    'outer_css_id' => 'mobile_content_top',
                        //                ));
                ...
                $this->widget('bootstrap.widgets.TbListView', array(
                    'dataProvider' => $modelAuto->searchForCategory(null, null),
                    'id' => 'auto-grid',
//                    'beforeAjaxUpdate'=>'js:function(xhr,ts,et,err,id){
//                        debugger;
//                        $("#"+id).text(err);
//                     }',
//                    'ajaxUrl'=>$modelCategory->getUrl(),
