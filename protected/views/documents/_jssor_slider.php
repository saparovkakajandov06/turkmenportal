...
<div style="position: relative; width: 100%; overflow: hidden;">
    ...
    <div id="slider1_container"
         style="position: relative; top: 0px; left: 0px; width: 800px;  min-height: 480px; border: 0px solid rgb(237, 237, 237);  background: #fff; overflow: hidden;">
        ...
        <!-- Slides Container -->
        <div u="slides" class="gallery"
             style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden; background: rgb(104, 104, 104);">
            <?php
            if (isset($documents) && is_array($documents)) {
                foreach ($documents as $document) {
                    $thumb = $document->resize(72, 72, "w", true);
                    $document->resize_quality = 100;
                    $image = $document->resize(852, 401, "h", true);
                    ...
                    <div>
                        ...
                        <a u="image" class="fancybox"
                           ...
                           data-fancybox="group" href="<?php echo $imageBig; ?>">
                            <img u="image" class="big" src="<?php echo $image; ?>" itemprop="image"
                                 alt="<?php echo $title; ?>"/>
                        </a>
