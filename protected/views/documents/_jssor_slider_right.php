...
?>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px;   border: 1px solid rgb(237, 237, 237);
        height: 456px; background: #F3F3F3; overflow: hidden;">
            ...
            <?php
                if(isset($documents) && is_array($documents)){
                    foreach ($documents as $document){
                        $thumb = $document->resize(99,66,"h",true);
                        $image = $document->resize(800,400,"auto",true);
                    ?>
                        <div>
