...
$this->breadcrumbs = array(
    Yii::t('app', 'Blog Descriptions') => array('index'),
    Yii::t('app', 'Manage'),
);
...
$.fn.yiiGridView.update('blog-description-grid', {
data: $(this).serialize()
});
return false;
});
...
<h1> <?php echo Yii::t('app', 'Manage'); ?> <?php echo Yii::t('app', 'Blog Descriptions'); ?> </h1>
