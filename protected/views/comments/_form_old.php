    ...
    ?>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          ...
          <div class="help-inline"><?php echo $form->error($model,'parent_id'); ?>
</div>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          ...
          <div class="help-inline"><?php echo $form->error($model,'like_count'); ?>
</div>
        </div>
      </div>
