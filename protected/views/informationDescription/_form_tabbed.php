<div class="form">
    ...
    <?php echo $form->hiddenField($model,'['.$model->language_id.']information_id'); ?>
    <?php echo $form->hiddenField($model,'['.$model->language_id.']language_id'); ?>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <?php echo $form->textField($model,'['.$model->language_id.']title',array('size'=>60,'maxlength'=>64)); ?>
        ...
        <div class="controls">
            <?php
                ...
                $this->widget('ext.editMe.widgets.ExtEditMe', array(
                    'model'=>$model,
                    'attribute'=>'['.$model->language_id.']description',
