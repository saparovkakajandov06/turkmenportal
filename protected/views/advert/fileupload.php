                ...
                <div class="col-xs-12">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <?php echo $model->getMixedDescriptionModel()->title; ?>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            if (isset($files)) {
                                $this->widget('XUpload', array(
                                    'url' => Yii::app()->createUrl("//site/fileupload", array('state_name' => 'state_catalog_files')),
                                    //our XUploadForm
                                    'model' => $files,
                                            ...
                                            <div class="haryt-image template-download fade in">
                                                ...
                                                <?php if(Yii::app()->controller->action->id=='fileupload') {?>
                                                    <div class="delete" style="position: absolute; top: 0px; right: 0px;">
                                                        <?php echo '<button style="margin: 0px;" class="btn" data-type="POST" data-url="'.Yii::app()->createUrl("//documents/delete",array('id'=>$document->id,'related_table_name'=>'tbl_catalog_to_files')).'">'; 
