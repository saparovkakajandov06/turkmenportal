                    ...
                    <tr class="template-download fade in" style="height: 82px;">
                        ...
                        <td class="delete">
                                ...
                                <?php if(Yii::app()->controller->action->id=='create' || Yii::app()->controller->action->id=='update') {
                                    echo '<button  class="btn btn-danger" data-type="POST" data-url="'.Yii::app()->createUrl("//documents/delete",array('id'=>$document->id,'related_table_name'=>'tbl_catalog_to_documents')).'">'; 
