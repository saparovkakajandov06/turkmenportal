...
$this->breadcrumbs = array(
    Yii::t('app', 'Estates Descriptions') => array('index'),
    Yii::t('app', 'Manage'),
);
...
$.fn.yiiGridView.update('estates-description-grid', {
data: $(this).serialize()
});
return false;
});
...
<h1> <?php echo Yii::t('app', 'Manage'); ?> <?php echo Yii::t('app', 'Estates Descriptions'); ?> </h1>
