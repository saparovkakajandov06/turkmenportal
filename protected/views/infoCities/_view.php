...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('citi_id')); ?>:</b>
	<?php echo CHtml::encode($data->citi_id); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('citi_name')); ?>:</b>
	<?php echo CHtml::encode($data->citi_name); ?>
	<br />
