...
$this->breadcrumbs = array(
    Yii::t('app', 'Polls Descriptions') => array('index'),
    Yii::t('app', 'Manage'),
);
...
$.fn.yiiGridView.update('polls-description-grid', {
data: $(this).serialize()
});
return false;
});
...
<h1> <?php echo Yii::t('app', 'Manage'); ?> <?php echo Yii::t('app', 'Polls Descriptions'); ?> </h1>
