...
$this->breadcrumbs = array(
    Yii::t('app', 'Catalog Descriptions') => array('index'),
    Yii::t('app', 'Manage'),
);
...
$.fn.yiiGridView.update('catalog-description-grid', {
data: $(this).serialize()
});
return false;
});
...
<h1> <?php echo Yii::t('app', 'Manage'); ?> <?php echo Yii::t('app', 'Catalog Descriptions'); ?> </h1>
