<?php
class AutoListviewWidget extends CWidget
{
    public $count;
...
//            $this->show_sub_header=false;
    ...
    public function run()
    {
            ...
            $dataProvider=$this->autoModel->searchForIndex($pagination_count);
            if($dataProvider->totalItemCount>0 || isset($_GET['mini_search']))
                $this->render('//autoListview/AutoListviewWidget', array('dataProvider'=>$dataProvider));
    }
}
?>
