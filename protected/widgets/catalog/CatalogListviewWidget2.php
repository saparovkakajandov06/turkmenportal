<?php
class CatalogListviewWidget2 extends CWidget
{
    public $count;
    public $page;
...
//        var_dump('sa');die;
        ...
        $dataProvider=$this->catalogModel->searchForCategory($this->count * $this->page);

        if($dataProvider->totalItemCount>0 || isset($_GET['mini_search']))
            $this->render($this->view, array('items'=>$dataProvider->getData(), 'page' => $this->page, 'count' => $this->count));
    }
}
?>
