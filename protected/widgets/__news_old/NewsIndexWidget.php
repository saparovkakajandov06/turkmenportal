...
class NewsIndexWidget extends CWidget
{
    ...
    public function run()
    {
        $blogModels=Blog::model()->sort_newest()->findAll(array('limit'=>10));
...
//        $popularBlogModels=Blog::model()->most_popular()->findAll(array('limit'=>5,'condition'=>'t.date_modified > '.  strtotime('-4 week') ));
        ...
        $this->render('NewsIndexWidget', array('bottomBlogModels'=>$bottomBlogModels,'mainBlogModel'=>$mainBlogModel,'newestBlogModels'=>$newestBlogModels, 'popularBlogModels'=>$popularBlogModels));
    }
}
?>
