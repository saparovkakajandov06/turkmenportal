...
$tag_it=Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('application.widgets.tag').'/tag-it.js');
$tag_it_css=Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('application.widgets.tag').'/tag-it.css');
