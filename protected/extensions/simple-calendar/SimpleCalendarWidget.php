...
class SimpleCalendarWidget extends CWidget {
    ...
    public function getMonthName() {
        return Yii::app()->dateFormatter->format('LLLL', $this->getTimestamp());
    }
    ...
    public function getDayLink($day) {
        return $this->getLink($this->year, $this->month, $day,$this->_url);
    }
    
    protected function getLink($year = null, $month = null, $day = null,$link="") {
        $params = array();
        if(!is_null($year)) {
            $params['year'] = $year;
        }
        ...
        return Yii::app()->getController()->createUrl($link, $params);
    }
