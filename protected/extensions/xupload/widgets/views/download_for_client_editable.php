    ...
    if(isset($this->docs) ){ ?>
        <?php foreach ($this->docs as $document) {
            if(isset ($document['thumbnail_url'])) {?>
                <div class="form-uploader-item template-download editable fade count_ in" style="height: 73px;">
                    ...
                    <div class="edit">
                        <a href="<?php echo $document['edit_url']; ?>" return="false"><i class="fa fa-edit white"></i></a>
                    </div>
                </div>
           <?php }?>
        <?php } ?>
